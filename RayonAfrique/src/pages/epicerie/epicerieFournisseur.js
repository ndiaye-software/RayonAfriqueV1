...
import CardFournisseur from "../../components/epicerie/cardFournisseur";
  ...
  return (
    <div>
      ...
      <Box
        ...
        textAlign="center"
      >
        <Typography variant="h5">Nos fournisseurs partenaires !</Typography>
      </Box>

      <Stack direction="row" justifyContent="space-between">
        <Box flex={4} p={{ xs: 0, md: 2 }} sx={{ backgroundColor: "#f9fafb" }}>
...
export default EpicerieFournisseur;
